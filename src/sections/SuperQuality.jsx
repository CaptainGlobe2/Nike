  ...
  return (
      <section
        ...
        <p className="mt-4 lg:max-w-lg info-text">
          Ensuring premium comfort and style, our meticulously crafted footwear is desinged to elevate your experinece, providing you with unmatched quality, innovation and touch of elegance.
        </p>
